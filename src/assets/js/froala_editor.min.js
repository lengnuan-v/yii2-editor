...
!function (e, t) {
    ...
    H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), H.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(H.LinkRegExCommon, ")"), H.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"), H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd), H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], H.MAIL_REGEX = /.+@.+\..+/i, H.MODULES.helpers = function (i) {
        ...
        function m(e) {
            for (var t = [A("9qqG-7amjlwq=="), A("KA3B3C2A6D1D5H5H1A3=="), A("3B9B3B5F3C4G3E3=="), A("QzbzvxyB2yA-9m=="), A("ji1kacwmgG5bc=="), A("nmA-13aogi1A3c1jd=="), A("BA9ggq=="), A("emznbjbH3fij=="), A("tkC-22d1qC-13sD1wzF-7=="), A("tA3jjf=="), A("1D1brkm==")], n = 0; n < t.length; n++) if (String.prototype.endsWith || (String.prototype.endsWith = function (e, t) {
        ...
        function E(e, t, n, r) {
            ...
            if (e.parents(t).length || void 0 === t) {
                ...
                return e.replaceWith('<span id="mark"></span>'), m.selection.text() ? (i = l.html().replace(/<span id="mark"><\/span>/, a + m.node.closeTagString(l.get(0)) + s + c + a + m.node.openTagString(l.get(0)) + s), l.replaceWith(m.node.openTagString(l.get(0)) + i + m.node.closeTagString(l.get(0)))) : (i = l.html().replace(/<span id="mark"><\/span>/, c), l.replaceWith(i)), !0
            }
            return !1
        }
        ...
        function r(e, t) {
            ...
            !function d(e, t, n, r) {
                for (var o = m.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                    var a = o[i];
                    if (m.node.hasClass(a, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < v(a).find(".fr-marker").length) t = d(v(a), t, n, r); else {
                ...
                return t
            }(m.$el, 0, e, t), n || (m.$el.find(".fr-marker").remove(), m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && m.$el.find(".fr-marker").before(H.INVISIBLE_SPACE).after(H.INVISIBLE_SPACE), m.html.cleanEmptyTags(), m.el.normalize(), m.selection.restore(), !m.selection.text() && v(m.selection.blocks()[0]).each(function (e, t) {
    ...
    h.fn = h.prototype = {
        constructor: h, length: 0, contains: function (e) {
            ...
            if ("string" == typeof e) {
                ...
                if (n < t.length && (e = document.createElement(t[n].trim()), n++), "string" != typeof e) for (var r = v(e); n < t.length; n++) {
                    t[n] = t[n].trim();
                    var o = t[n].split("=");
    ...
    return E.Bootstrap = function (e, t, n) {
        ...
        this.$oel.parents("form").off(".".concat(this.id)), this.$oel.off("click.popup"), this.$oel.removeData("froala.editor"), this.$oel.off("froalaEditor"), this.core && e && this.core.destroy(e), E.INSTANCES.splice(E.INSTANCES.indexOf(this), 1)
    }, H
});